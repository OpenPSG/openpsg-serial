...
__export(index_exports, {
  ...
  Flags: () => Flags,
  Message: () => Message,
  REGISTER_DEVICE_NAME: () => REGISTER_DEVICE_NAME,
  REGISTER_DEVICE_START: () => REGISTER_DEVICE_START,
  REGISTER_FIRMWARE_VERSION: () => REGISTER_FIRMWARE_VERSION,
  REGISTER_PRODUCT_ID: () => REGISTER_PRODUCT_ID,
